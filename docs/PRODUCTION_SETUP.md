...
For architecture details see [ARCHITECTURE.md](ARCHITECTURE.md). For access control, secrets rotation, retention, supply chain, and incident response see [SECURITY_OPERATIONS.md](SECURITY_OPERATIONS.md).
